...
export const HowItWorks = () => (
    <section
      className="relative z-[2] py-[100px] border-t border-line"
      id="how"
    >
      <div className="max-w-[1280px] mx-auto px-8">
        ...
        <h2 className="font-serif font-normal mb-6 leading-[1.05] tracking-[-0.03em] text-[clamp(36px,5vw,56px)] max-w-[800px]">
          Quatre étapes.{" "}
          <em className="italic font-light text-orange">Zéro friction.</em>
        </h2>
        <p className="text-lg text-ink-soft max-w-[640px] leading-[1.6]">
          Connectez votre instance Jira, ouvrez un ticket, lancez
          l&apos;analyse. Le commentaire se poste tout seul. C&apos;est tout.
        </p>
        ...
        <div className="mt-[70px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-0">
          {steps.map((step, i) => (
            <div
              ...
              className={`p-8 pl-0 ${
                i < steps.length - 1
                  ? "lg:border-r lg:border-dashed lg:border-line"
                  : ""
              }`}
            >
              ...
              <p className="text-ink-soft text-sm leading-[1.55]">
                {step.desc}
              </p>
            </div>
          ))}
